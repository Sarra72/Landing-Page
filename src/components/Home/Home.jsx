  ...
  return (
    <>
      <div className="home-bd container">
        <img src="././src/assets/spices.png" alt="spices image" className='spices' />
        <img src="././src/assets/onion-and-tomato.png" alt="onion-and-tomato image" className='onion-and-tomato' />
        <div className="mid">
          <div className="mid-f">
            ...
            <img src="././src/assets/main-img.png" alt="sushi image" className='suhsi' />
           </div>
      </div>
    </>
  )
